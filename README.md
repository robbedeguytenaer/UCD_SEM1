...
<p>
  <img src="https://github.com/korneelverraes/tussentijds-rapport/assets/88773280/b92d9d28-47f9-425c-8d22-e52728740833" width="35%"/>
  <img src="https://github.com/korneelverraes/tussentijds-rapport/assets/88773280/7543fa3a-3238-4145-b062-8d649b2974c4" width="28%"/>
  <img src="https://github.com/korneelverraes/tussentijds-rapport/assets/88773280/7d9ae298-c574-4e09-a875-06955b0f1f41" width="35%"/>
</p>

#### User interface
Uit de eindscores van de eerste gebruikerstesten konden we met de meest ideale *dial*vorm opnieuw naar de gebruiker trekken. Deze keer werd bewust gekozen voor nieuwe testpersonen. Door het kiezen van nieuwe testpersonen kunnen er nieuwe visies ontstaan en kunnen we al dan niet bevestigd krijgen of de gebruiker ons concept begrijpt.
...
We blikken terug op een periode met een effectieve en vlotte samenwerking en kijken ernaar uit om in het tweede semester te werken aan de ontwikkelings- en eindfase. Moesten we de definitiefase opnieuw kunnen doen zouden we tussen de eerste testen met de *dial*vormen en -groottes iets meer tijd gelaten hebben. Zo zouden we een uitgebreidere interactie kunnen gaan ontwerpen om een tweede maal met een iets realistischer prototype naar de gebruiker te trekken. We hadden graag in deze fase nog getest hoe gebruikers het liefst tactiele feedback ontvangen van de *dial*. Hoe intens en hoe snel moet de vibratie zijn bij het bedienen van de *dial*? 
Voor de materiaalkeuze van de *dial* trokken we naar enkele gebruikers met een houten plaatje met daarop 6 verschillende materialen. We wilden een diverse keuze aan materialen voorstellen, maar hierop baseerden we ons op gevonden materialen. Graag hadden we eigenlijk wat meer tijd gehad om bijvoorbeeld verschillende 3D-printmaterialen erbij te plaatsen zoals poederprints. Of hadden we opzoek kunnen gaan naar speciale en duurzame metalen. In het tweede semester zullen we een definitieve *dial* 3d-printen en zouden we opnieuw naar een beperkte gebruikersgroep kunnen trekken met wat poederprints, zachte prints om nog eens bij een andere groep te polsen welke materialen zij prefereren.
Als we kijken naar het prototypen van een *head-up-display* dan hebben we daar misschien nog wel de grootste uitdaging voor ons. Een minimaal *head-up-display* dat toch een breed scala aan informatie kan weergeven en vooral uiterst vloeiend samenwerkt met de dial en het touchscreen. De uitdaging bestaat uit een combinatie van het voordeel waarbij de ogen niet van de baan moeten wijken om informatie te zien of te wijzigen, maar ook uit het gevaar dat te veel informatie voor je ogen evenwel voor afleiding zal zorgen. Om het *head-up-display* praktisch te gaan realiseren hebben we oog op verschillende methodes. Zo bestaan er heel wat simpele methodes om aan de hand van een schermpje en twee spiegels de informatie te gaan projecteren op een raam. We kunnen hiervoor ook gaan samenwerken met andere studenten.
Als we alle afzonderlijke aspecten hebben gemaakt en onderzocht zal de uitdaging eruit bestaan dit samen te brengen tot een mooi en realistisch geheel waarmee we naar de gebruiker kunnen trekken en laatste conclusies trekken uit de gevoelens die vrijkomen bij de gebruiker tijdens het testen van ons concept. Hoe kunnen we ons concept duidelijk gaan overbrengen in een realistisch ontwerp? 
