...
Een ander kritisch punt dat we willen aankaarten is de validiteit van onze testen. Naast het feit dat we meer tijd moesten voorzien hebben tussen de twee testen, hadden we best ook gekeken om de testen te doen plaatsvinden in een meer reallistische omgeving. Nu waren de testen gewoon in een woonkamer, beter zou zijn dat de testpersonen zich meer kunnen inleven in de situatie en bijvoorbeeld de interfacetest in een echte auto kon plaatsvinden. Dan zou het interface gepositioneerd kunnen worden op de plaats waar in die auto het huidige infotainmentsysteem zich bevindt. 
In de volgende fases gaan we ons alvast meer richten op de totaalervaring in reëele contexten. De validiteit moet beter en we willen vooral gaan kijiken in welke mate ons product effectief zorgt voor minder afleiding.
